...
`,
  ...
  "bedroom": {
    ...
    <p class="book__text">
    Пересилив себя, вы только подходите к кровати, чтобы потрогать бельё, постояли у окна, убедившись, что там тот же прекрасный зимний лес. На тумбочке вы заметили белый, едва заметный, ключ.
    </p>
    <p class="book__text">
    Решив, что ловить здесь нечего, вернулись к двери и не смогли её открыть. Также вы обратили внимание, что замочных отверстия два, а не одно.
    </p>`,
    descriptionW: `
      <p class="book__text">
  ...
  "workroom": {
    ...
    <p class="book__text">
      Перед вами был сейф, на котором было написано "Следующий шаг ждёт тебя здесь". На столе лежал тетрадный листок, наполовину исписанный четырёхзначными числами. Некоторые цифры были выделены красным цветом.
    </p>`,
    descriptionW: `
      <p class="book__text">
        Оу, загадочный сейф - я снова пришёл к тебе. Теперь-то я знаю что делать и как.
      </p>
      <p class="book__text">
  ...
  "predictions": {
    room: 'predictions',
    title: "Развязка",
    description: `<p class="book__text">Мандарины закончились... Вы сели на ближайший стул и вас потянуло в сон...</p>
