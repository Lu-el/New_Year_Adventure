...
`,
  ...
  'storeroom': {
    ...
    task: `Вы начинаете ощупывать стену, чтоб найти выключатель. насколько быстро вы справитесь с этим заданием - зависит только от вашей удачи.
      Стена условно разделена на 15 частей - кликать необходимо поочередно на один из квадратов. Считаются именно кликания по комнате. Справьтесь как можно скорее.
      `,
    ending: `Наконец-то вам удалось включить свет и немного выдохнуть. Это оказалась кладовка незнакомца - мешки, коробки, старый мотор - всё как у всех.
      Вы выдохнули, что не нашли здесь бензопилу, топор, пилу... На другом конце комнаты вы увидели картину с дверью или не картину? Подойдя поближе рассмотрели реальную дверь. "Отлично, можно двигаться дальше"`,
  ...
  "library": {
    ...
    title: "Библиотека",
    description: `
      <p class="book__text">Просторная комната, множество книг
      </p>
      <p class="book__text">
      </p>
      <p class="book__text">
