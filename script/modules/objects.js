...
`,
    ...
    ending: `У вас оказались мандарины с собой. Откуда они появились - вы скоро узнаете. Чем меньше вы их тратите - тем больше мест сможете посетить. Иногда это будет зависеть только от удачи, а иногда и от вашей логики. Как только они закончаться или вы долго будете бродить в этом месте - наступит развязка истории.`,
    mission: `
