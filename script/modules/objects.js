...
`,
  ...
  'kitchen': {
    ...
    descriptionW: `
      <p class="book__text">
        Снова кухня, снова вкусные запахи из печи! Сейчас бы сьесть того приготовленного блюда. Но судя по переполоху, который происходил на кухне, оно ещё не было готово. А что будет, если добавить второе блюдо или тоже самое в их работу?
      </p>`,
    task: `
  ...
  'storeroom': {
    ...
    task: `Вы начинаете ощупывать стену, чтоб найти выключатель. на сколько быстро вы справитесь с этим заданием - зависит только от вашей удачи.
  ...
  "dining": {
    ...
    descriptionW: `
      <p class="book__text">
        На столе снова бардак из тарелок, кто же его устраивает? Ваш внутренний перфекционист протестует, здравый смысл тоже - ведь если сделаете тоже самое, снова пинок под з... попу.
      </p>
      <p class="book__text">
        Осмотревшись в комнате, вы не находите ничего умнее, чем просто сесть за стол на тот же самый стул, но уже готовым получить за это пинок, но хотя бы в другую комнату.
      </p>
      <p class="book__text">
  ...
  "bedroom": {
    ...
    description: `
    <p class="book__text">
    Спальня в старорусском стиле предстала перед вами. Резная кровать, шелковое белое белье, подушки пирамидкой - всё это манило к себе и как-будто говорило: ляг - отдохни, расслабься, подумаешь в лесу поздним вечером...
    </p>
    <p class="book__text">
  ...
  "workroom": {
    ...
    description: `
    <p class="book__text">
      Кабинет этого волшебника был небольшим, стол малогабаритным - места было только на один листок А4.
    </p>
    <p class="book__text">
      Вы прошлись по этой маленькой комнате, погрели руки у камина, присели на пуфик и стали думать, что делать дальше.
    </p>
    <p class="book__text">
      Перед вами был сейф, на котором было написано "Слудющий шаг ждёт тебя здесь". На столе лежал тетрадный листок, наполовину исписанный четырёхзначными числами. Некоторые цифры были выделены красным цветом.
    </p>`,
    descriptionW: `
      <p class="book__text">
