...
// результат тестов выводить
// в библиотеке изменить таск
// добавить новые мото
// на кухне доработать комп версию
// на кухне сделать картинки с названиями
...
`,
  ...
  "library": {
    ...
    task: `
      Перед вами будет 9 вопросов - необходимо ответить на них как можно правильнее. Правильные ответы вы не узнаете сразу, чтобы не помогать своим домодчадцам. ТАЙМЕР???
    `,
